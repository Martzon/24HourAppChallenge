...
![challenge-app-example](challenge-app-example.png)

Run `ng serve --port 8081` for a dev server. Navigate to `http://localhost:8081/`. The app will automatically reload if you change any of the source files.

For instruction, please visit:
> [Angular 16 CRUD example with Rest API](https://www.bezkoder.com/challenge-app-example/)
...
> [Angular 16 + Spring Boot example](https://www.bezkoder.com/spring-boot-challenge-app/)
